...
<div class="col-md-6">
        ...
        <div class="col-md-6">
            <form:form action="/productSave" method="post" modelAttribute="product">
		       ...
		       <div class="form-group">
		        ...
		        <button type="button" class="btn btn-primary" onclick="window.location.href='/Lab6AddNew';">Add</button>
		        <button type="submit" class="btn btn-secondary">Update</button>
		        <button type="button" class="btn btn-danger" onclick="window.location.href='/Lab6Remove/${product.id}';">Remove</button>
				<button type="button" class="btn btn-danger" onclick="window.location.href='/Lab6';">Back To Product List</button>
		    </form:form>
        </div>
    </div>
    ...
    <table class="table">
        ...
        <c:forEach items="${products}" var="prod">
            ...
            <tr onclick="window.location='/Lab6Detail/${prod.id}'" style="cursor:pointer;">
                <td>${prod.id}</td>
                <td>${prod.name}</td>
                <td>${prod.price}</td>
